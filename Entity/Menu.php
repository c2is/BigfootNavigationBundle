...
class Menu
{
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Bigfoot\Bundle\NavigationBundle\Entity\Menu\Item", mappedBy="menu", cascade={"persist", "merge", "remove"}, orphanRemoval=true, onDelete="CASCADE")
     */
    private $items;
